...
export default class BgFillButton extends FloatingActionButton {
  constructor() {
    const darkTitle = 'Preview on dark background';
    ...
    this._darkTitle = darkTitle;
    this._lightTitle = lightTitle;
  }
  ...
  onClick(event) {
    ...
    if (this.container.classList.contains('active')) {
      ...
      this.container.setAttribute('title', this._darkTitle);
    } else {
      this.container.classList.add('active');
      document.documentElement.classList.add('bg-dark');
      this.container.setAttribute('title', this._lightTitle);
    }
  }
}
